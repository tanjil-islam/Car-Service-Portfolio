...
export default function SpecsGrid() {
  return (
    <section id="specs" className="py-24 px-6 md:px-12 bg-gradient-to-b from-[#1a1a1a] to-[#121212] border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {technicalSpecs.map((category, idx) => (
            ...
            >
              <div className="absolute top-0 left-0 w-8 h-[1px] bg-pagani-gold" />
