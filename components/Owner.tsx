    ...
    <section id="owner" className="py-32 px-6 md:px-16 lg:px-24 bg-void relative overflow-hidden">
      <div className="max-w-[1920px] mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          {/* Graphic / Avatar side */}
          <div className="lg:col-span-6 relative h-[600px] md:h-[800px] rounded-2xl overflow-hidden group">
            ...
            <div className="absolute bottom-0 left-0 p-8 z-20 w-full bg-gradient-to-t from-void/90 via-void/50 to-transparent">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center pl-0 lg:pl-12">
            <span className="font-mono text-xs tracking-[0.4em] text-plasma mb-6 uppercase flex items-center gap-4">
              <span className="w-12 h-[1px] bg-plasma" /> CHIEF ENGINEER
            </span>
            <h2 className="font-bebas text-6xl md:text-8xl tracking-wider text-text uppercase mb-2">
            ...
            <p className="text-sm md:text-base text-muted leading-relaxed tracking-wide mb-12 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-10 items-start sm:items-center justify-between border-t border-white/10 pt-10">
              {/* Animated Experience Counter */}
              <div ref={counterRef} className="flex flex-col">
                <span className="text-[10px] font-mono text-plasma tracking-widest uppercase mb-2">
                  EXPERIENCE RECORD
                </span>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex gap-3 flex-wrap">
                  <span className="px-5 py-2 bg-white/5 border border-white/10 text-text text-[10px] font-mono tracking-widest uppercase rounded-full">
                    ASE MASTER TUNE
                  </span>
                  <span className="px-5 py-2 bg-white/5 border border-white/10 text-text text-[10px] font-mono tracking-widest uppercase rounded-full">
                    3D COMPOSITES
                ...
                <div className="flex gap-4 items-center text-xs font-mono text-muted uppercase tracking-widest">
                  <span className="text-[10px] text-muted/50">// SOCIAL INDEX:</span>
