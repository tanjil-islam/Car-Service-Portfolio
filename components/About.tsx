...
export default function About() {
  ...
  return (
    <section id="about" className="py-16 md:py-32 px-4 sm:px-6 md:px-16 lg:px-24 bg-void relative">
      <div className="max-w-[1920px] mx-auto">
        
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 md:mb-20 border-b border-white/10 pb-12">
          <div className="max-w-3xl">
            <span className="font-mono text-xs tracking-[0.4em] text-plasma mb-6 block uppercase">
              // THE FOUNDATION
            </span>
            <h2 className="font-bebas text-4xl md:text-6xl tracking-wider text-text uppercase leading-[0.9]">
              OBSESSIVE <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8 lg:gap-4 md:gap-8 md:gap-16 items-start">
          ...
          <div className="lg:col-span-7 h-[50vh] md:h-60vh md:h-[60vh] md:h-80vh relative perspective-container" ref={containerRef}>
            ...
            >
              <motion.img 
                ...
                className="w-full h-full object-cover filter contrast-[1.1] opacity-100"
                style={{ 
              ...
              <motion.div 
                ...
                style={{ z: 80 }}
              >
                <div className="font-mono text-xs tracking-widest text-plasma mb-2 drop-shadow-glow-plasma-sm">FIG 01. AERODYNAMIC FLOW</div>
          ...
          <div className="lg:col-span-5 flex flex-col pt-10">
            ...
            <p className="text-muted leading-relaxed tracking-wide mb-6 md:mb-12">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 border-t border-white/10 pt-10">
